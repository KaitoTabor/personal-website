    ...
    return (
        <div className="flex items-center justify-center p-[2vh] pr-0 md:p-[5vw] md:pr-0 relative z-10">
            <Card className="rounded-none rounded-r-none relative overflow-hidden w-[42.75vh] h-[86vh] md:w-[66.75vw] md:h-[44.5vw]">
                ...
                <div className="absolute  top-[35vh] left-[11vh] text-[8vh] font-kanji w-full flex justify-end right-[1vh] md:-top-[23vw] rotate-90 md:text-[8vw] md:left-[28.5vw]">
                    有安
                </div>
                ...
                <div className="absolute text-[7vh] top-[40vh] right-[8vh] font-kanji w-full flex justify-end   md:rotate-90 md:text-[8vw] md:top-[0vw] md:left-[21.5vw]">
                    海飛
                </div>
                <div className="absolute top-[80vh] text-[5vh] font-kanji w-full flex justify-start left-[1vh] md:top-[38.5vw] md:text-[5vw] md:left-[1vw]">
                    ポートフォリオ
                </div>
                <div className="absolute top-[76vh] text-[4.5vh] font-kanji w-full flex justify-start left-[1vh] md:top-[34.5vw] md:text-[5vw] md:left-[1.5vw]">
                    Portfolio
                </div>
